// One-off generator for the "Policy Time Machine" blog post Open Graph card.
// Run with: node scripts/generate-policy-time-machine-og.mjs
//
...
const WIDTH = 1200;
const HEIGHT = 630;
const SCREENSHOT = 'src/assets/policy-time-machine/ptm-video-poster.webp';
const OUTPUT = 'scripts/og-art/policy-time-machine.webp';
...
<svg width="${WIDTH}" height="${HEIGHT}" viewBox="0 0 ${WIDTH} ${HEIGHT}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="88" y="208" font-family="Helvetica, Arial, sans-serif" font-size="26" font-weight="600" fill="#c3cad6" letter-spacing="3">PROJECT</text>

  <text font-family="Helvetica, Arial, sans-serif" font-size="64" font-weight="800" fill="#ffffff">
    <tspan x="88" y="300">Policy Time</tspan>
    <tspan x="88" y="374">Machine</tspan>
  </text>
  <text x="88" y="434" font-family="Helvetica, Arial, sans-serif" font-size="26" fill="#8a93a3">Tomorrow's rules on yesterday's decisions</text>
